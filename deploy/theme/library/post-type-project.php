...
function custom_post_example() { 
	...
	register_post_type( 'project', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array('labels' => array(
			...
			'description' => __( 'Projects Jordan has done and worked on.', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
	...
	*/
    ...
    register_taxonomy( 'project_roles', 
    	array('project'), /* if you change the name of register_post_type( 'custom_type', then you have to change this */
    	array('hierarchical' => true,     /* if this is true, it acts like categories */             
    		'labels' => array(
    			'name' => __( 'Project Roles', 'bonestheme' ), /* name of the custom taxonomy */
    			'singular_name' => __( 'Project Role', 'bonestheme' ), /* single taxonomy name */
    			'search_items' =>  __( 'Search Project Roles', 'bonestheme' ), /* search title for taxomony */
    			'all_items' => __( 'All Project Roles', 'bonestheme' ), /* all title for taxonomies */
    			'parent_item' => __( 'Parent Project Role', 'bonestheme' ), /* parent title for taxonomy */
    			'parent_item_colon' => __( 'Parent Project Role:', 'bonestheme' ), /* parent taxonomy title */
    			'edit_item' => __( 'Edit Project Role', 'bonestheme' ), /* edit custom taxonomy title */
    			'update_item' => __( 'Update Project Role', 'bonestheme' ), /* update title for taxonomy */
    			'add_new_item' => __( 'Add New Project Role', 'bonestheme' ), /* add new title for taxonomy */
    			'new_item_name' => __( 'New Project Role Name', 'bonestheme' ) /* name title for taxonomy */
    		),
